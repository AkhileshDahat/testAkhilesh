/*
  ...
  <script type = "text/javascript" src = "../poll/js/ajaxgold.js"></script>
  ...
  if(XMLHttpRequestObject) {
    ...
    XMLHttpRequestObject.onreadystatechange = function()
    {
      if (XMLHttpRequestObject.readyState == 4 && XMLHttpRequestObject.status == 200) {
          callback1(XMLHttpRequestObject.responseText);
...
function getDataReturnTextDIV(url, divID)
{
  var XMLHttpRequestObject = false;
  ...
  if(XMLHttpRequestObject) {
    ...
    {
      if (XMLHttpRequestObject.readyState == 4 && XMLHttpRequestObject.status == 200) {
          obj.innerHTML = XMLHttpRequestObject.responseText; /* SET THE DIV innerHTML CONTENT TO THE FILE DATA IN TEXT FORMAT */
          delete XMLHttpRequestObject;
          XMLHttpRequestObject = null;
      }
      else {
