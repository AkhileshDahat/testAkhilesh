...
//
if (!defined( '_VALID_MVH' )) { define( '_VALID_MVH', 1 ); }
if (file_exists("../../../../config.php")) { require_once "../../../../config.php"; } // THIS WORKS IN THE CORE FUNCTION
if (file_exists("../../../config.php")) { require_once "../../../config.php"; } // THIS WORKS FOR RICOXMLQUERY.php

require $GLOBALS['dr']."include/rico21/plugins/php/dbClass2.php";
...
function OpenDB() {
  ...
  return $oDB->MySqlLogon($GLOBALS['appDB'], $GLOBALS['database_user'], $GLOBALS['database_password']);
...
function OpenTableEdit($tabname) {
  ...
  $obj->options["XMLprovider"]=$GLOBALS['wb']."include/rico21/examples/php/ricoXMLquery.php";
