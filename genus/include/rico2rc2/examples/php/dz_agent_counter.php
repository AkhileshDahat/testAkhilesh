...
//************************************************************************************************************
if (OpenGridForm("", "agent_counter_master")) {
...
function DefineFields() {
  ...
  $oForm->AddEntryField("agent_counter_id", "ID", "B", "<auto>");
  $oForm->CurrentField["width"]=50;

  $oForm->AddEntryField("agent_id", "Agent", "SL", "");
  $oForm->CurrentField["SelectSql"]="SELECT agent_id, agent_name FROM agent_detail_master";
  $oForm->CurrentField["width"]=100;

  $oForm->AddEntryField("user_login", "Login", "T", "");
  $oForm->CurrentField["width"]=150;

  $oForm->AddEntryField("user_password", "Password", "T", "");
  $oForm->CurrentField["width"]=150;

  $oForm->AddEntryFieldW("title", "Title", "N", "",100);
  $oForm->CurrentField["width"]=100;

  $oForm->AddEntryField("full_name", "Name", "T", "");
  $oForm->CurrentField["width"]=150;

  $oForm->AddEntryField("gender", "Gender", "F", "");
  $oForm->CurrentField["width"]=150;

  $oForm->AddEntryField("identity_number", "ID#", "T", "");
  $oForm->CurrentField["width"]=150;
  ...
  $oForm->AddEntryField("country", "Country", "T", "");
  $oForm->CurrentField["width"]=150;

  $oForm->AddEntryField("mobile_phone", "Mobile # 3", "T", "");
  $oForm->CurrentField["width"]=150;

  $oForm->AddEntryField("email", "Email 3", "T", "");
  $oForm->CurrentField["width"]=150;
