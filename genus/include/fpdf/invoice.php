...
{
    $this->SetFont( "Arial", "", 10);
    $length = $this->GetStringWidth( "ATTENTION : " . $ref );
    $r1  = 10;
    $r2  = $r1 + $length;
    $y1  = 92;
    $y2  = $y1+5;
    $this->SetXY( $r1 , $y1 );
    $this->Cell($length,4, "ATTENTION : " . $ref);
}
...
function addCadreEurosFrancs($total)
{
    $r1  = $this->w - 70;
    $r2  = $r1 + 60;
    $y1  = $this->h - 40;
    ...
    //$this->Line( $r1, $y1+4, $r2, $y1+4); // Sous Euros & Francs
    $this->Line( $r1+30,  $y1, $r1+30, $y2); // Entre Euros & Francs
    //$this->SetFont( "Arial", "B", 8);
    //$this->SetXY( $r1+22, $y1 );
    ...
    $this->SetFont( "Arial", "B", 12);
    $this->SetXY( $r1+2, $y1+8 );
    $this->Cell(20,4, "TOTAL DUE", 0, 0, "C");

    $this->SetFont( "Arial", "B", 12);
    $this->SetXY( $r1+22, $y1+8 );
    $this->Cell(50,4, "MYR $total", 0, 0, "C");
}
