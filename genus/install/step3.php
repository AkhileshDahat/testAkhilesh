...
function CreateConfigFile() {
	...
	$db_setup.="defined( '_VALID_MVH' ) or die( 'Direct Access to this location is not allowed.' );\n";
	$db_setup.="\n";
	...
	$db_setup.=ConfigRow("Use Wiki URL","wiki_url","http://code.google.com/p/genusproject/w/list");
	$db_setup.="\n";
