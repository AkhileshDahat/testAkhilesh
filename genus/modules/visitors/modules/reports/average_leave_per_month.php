...
require_once($GLOBALS['dr']."classes/reporting/gen_xml_file_bars.php");
...
function SubTask() {
	...
	/* GRAB THE DATA HERE */
	$obj_gd=new GenData;
	$sql="SELECT ROUND(AVG(total_days),1) as total, monthname(date_from) as month_name
	...
	$obj_gxf->SetVar("header","Average Days Leave Per Month");
	...
	$c.="<div id=\"chart\" class=\"chart\">\n";
		$c.="<embed type=\"application/x-shockwave-flash\" src=\"bin/reporting/swf/fcp-bars.swf\" id=\"flashchart\" name=\"flashchart\" bgcolor=\"#ffffff\" quality=\"high\" flashvars=\"config=bin/reporting/xml/bar_".$_SESSION['sid'].".xml\" height=\"500\" width=\"700\">\n";
	$c.="</div>\n";
	$c.="<script type=\"text/javascript\">\n";
	$c.="var source = new SWFObject('bin/reporting/swf/fcp-bars.swf', 'flashchart', '700', '500', 5, \"#ffffff\");\n";
