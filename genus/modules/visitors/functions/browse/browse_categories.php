...
function BrowseCategories() {
	...
	for ($i=0;$i<$sr->CountRows();$i++) {
		...
		$sr->ModifyData($i,2,"<a href='index.php?module=visitors&task=categories&subtask=edit&category_id=".$category_id."' title='Edit'>Edit</a>");
		$sr->ModifyData($i,3,"<a href='index.php?module=visitors&task=categories&subtask=delete&category_id=".$category_id."' title='Delete'>Delete</a>");
	}
	$sr->RemoveColumn(0);
