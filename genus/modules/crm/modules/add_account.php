...
require_once $GLOBALS['dr']."modules/crm/functions/forms/add_account.php";
require_once $GLOBALS['dr']."modules/crm/classes/account_id.php";
...
function LoadTask() {
	...
	if (ISSET($_POST['account_name'])) {
		...
		$ai=new AccountID;
		$result_add=$ai->Add($_POST['account_name'],$_POST['industry_id'],$_POST['user_id_assigned'],$_POST['phone_number'],
