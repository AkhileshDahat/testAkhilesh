...
function InstalledWorkspaceModules($workspace_id) {
	...
	$sql="SELECT mm.name,mm.description,
				concat('<a href=index.php?module=core&task=workspace_module_roles&subtask=del&workspace_id=',workspace_id,'&module_id=',csm.module_id,'>Permissions</a>') as doedit
