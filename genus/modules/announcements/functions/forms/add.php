...
function Add($message="") {
	...
	/* DESIGN THE FORM */
	$form=new CreateForm;
	$form->SetCredentials("index.php?module=announcements&task=add","post","send_sms","onSubmit=\"ValidateForm(this)\"");
	$form->Header("../modules/sms/images/default/send_sms.png","Add a new announcement");
