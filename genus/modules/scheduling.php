...
include($GLOBALS['dr']."modules/scheduling/config.php");

/* MENU FILE */
include($GLOBALS['dr']."modules/scheduling/functions/menu.php");
	...
	$c.="<table>\n";
		$c.="<tr>\n";
			...
			if (ISSET($_GET['task']) && CheckAccess($GLOBALS['wui']->RoleID(),$module_id,$_GET['task'])) {
				...
				$file_inc=$GLOBALS['dr']."modules/scheduling/modules/".$_GET['task'].".php";
