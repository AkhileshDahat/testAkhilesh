...
require_once $GLOBALS['dr']."modules/scheduling/classes/scheduling_students_timetable.php";

global $obj_slt;

function BrowseStudentsTimetable() {
...
$obj_slt=new SchedulingStudentTimetable;
