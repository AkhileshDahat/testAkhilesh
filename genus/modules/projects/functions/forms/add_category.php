...
function AddCategory($category_id="",$category_name="") {
	...
	/* DESIGN THE FORM */
	$form=new CreateForm;
	$form->SetCredentials("index.php?module=projects&task=categories","post","add_category","onSubmit=\"ValidateForm(this)\"");
	$form->Header("crystalclear/48x48/apps/access.png","Categories");
	$form->Input("Category","category_name","","","",$category_name);
	$form->Hidden("category_id",$category_id);
	//$form->ShowDropDown("Category","category_id","category_name","project_category_master","category_id",$category_id,"","WHERE workspace_id = ".$GLOBALS['workspace_id'],"","input_reqd");
