...
require_once $GLOBALS['dr']."modules/hrms/functions/exists/workspace_role_id_exists.php";
require_once $GLOBALS['dr']."modules/hrms/functions/exists/login_exists.php";
require_once $GLOBALS['dr']."modules/hrms/functions/exists/title_id_exists.php";
