...
function CategoryTrend() {
	...
	$c.="<div class='hideBlk' id='srch_filter'>\n";
		...
		$form->Header("crystalclear/48x48/apps/access.png","Compare Categories");

		$form->Hidden("module","helpdesk");
		$form->Hidden("task","reports");
		$form->Hidden("report","category_trend");
	...
	$c.="<img src='modules/helpdesk/bin/reports/category_trend.php?significance_id=".$significance_id."&yr=".$yr."' border='0'></a>";
