...
function BrowseSignificance() {

	$sql="SELECT significance_id,significance_name,
							concat('<a href=index.php?module=helpdesk&task=priorities&subtask=edit&significance_id=',significance_id,' title=Browse>Edit</a>') as edit,
							concat('<a href=index.php?module=helpdesk&task=priorities&subtask=delete&significance_id=',significance_id,' title=Browse>Delete</a>') as del
