...
function BrowseTags() {
	...
	$sql="SELECT tag_id,tag_name,
							concat('<a href=index.php?module=helpdesk&task=tags&subtask=edit&tag_id=',tag_id,' title=Browse>Edit</a>') as edit,
							concat('<a href=index.php?module=helpdesk&task=tags&subtask=delete&tag_id=',tag_id,' title=Browse>Delete</a>') as del
