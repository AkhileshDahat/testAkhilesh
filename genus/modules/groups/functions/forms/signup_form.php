...
require_once $dr."modules/hrms/classes/new_user.php";
require_once $dr."modules/workspace/classes/new_workspace.php";

require_once $dr."modules/hrms/functions/defaults/role_id_default.php";
require_once $dr."modules/workspace/functions/defaults/default_workspace_signup_status_id.php";
...
function SignupForm() {
	...
	*/
	$c="<table class='plain_border'>\n";
		...
		$c.="</tr>\n";
		$c.="<tr>\n";
			$c.="<td valign='top' class='head' colspan='4'>".DrawSubmit("submit","Save Details","buttonstyle","signup",True)."&nbsp;".DrawSubmit("reset",_RESET_FORM_,"buttonstyle","reset")."&nbsp;</td>\n";
		$c.="</tr>\n";
	$c.="</form>\n";
	$c.="</table>\n";
	return $c;
