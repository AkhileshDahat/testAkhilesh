...
class BookmarkID {
	...
	public function Delete() {
		...
		if (!$this->parameter_check) { $this->Errors("Parameter check failed!"); return False; }
		if (!$this->BookmarkExists($_SESSION['user_id'],$this->category_id)) { $this->Errors("Invalid bookmark!"); return False; }

		/* DATABASE CONNECTION */
		$db=$GLOBALS['db'];

		/* INSERT TO THE DATABASE */
		$sql="DELETE FROM ".$GLOBALS['database_prefix']."document_user_bookmarks
