...
class CategoryBalance {
	...
	private function Info() {
		...
		$sql="SELECT category_name,allow_negative_balance
	...
	public function Add($category_name,$allow_negative_balance) {
		...
		$sql="INSERT INTO ".$GLOBALS['database_prefix']."leave_category_master
					(category_name,allow_negative_balance,workspace_id)
					VALUES (
					'".$category_name."',
	...
	public function Edit($category_name,$allow_negative_balance) {
