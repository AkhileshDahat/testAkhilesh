...
require_once($GLOBALS['dr']."classes/reporting/gen_xml_file.php");
...
function SubTask() {
	...
	$c.="<div id=\"chart\" class=\"chart\">\n";
		$c.="<embed type=\"application/x-shockwave-flash\" src=\"bin/reporting/swf/fcp-line-chart.swf\" id=\"flashchart\" name=\"flashchart\" bgcolor=\"#ffffff\" quality=\"high\" flashvars=\"config=bin/reporting/xml/fcp-unicode-charts-v3.xml\" height=\"500\" width=\"700\">\n";
	$c.="</div>\n";
	$c.="<script type=\"text/javascript\">\n";
	$c.="var source = new SWFObject('bin/reporting/swf/fcp-line-chart.swf', 'flashchart', '700', '500', 5, \"#ffffff\");\n";
	$c.="source.addVariable(\"config\", 'bin/reporting/xml/fcp-unicode-charts-v3.xml');source.write(\"chart\");\n";
	$c.="</script>\n";
