...
function LoadTask() {
	...
	elseif (ISSET($_GET['application_id'])) {
		...
		$category_id=$ai->GetInfo("category_id");
	...
	*/
	if ($show_form) {
		$c.=Apply($date_from,$date_from_half_day,$date_from_half_day_am_pm,$date_to,$date_to_half_day,$date_to_half_day_am_pm,$category_id,$remarks,$application_id);
	}
